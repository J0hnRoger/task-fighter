...
public class TaskFighterTests
{
    ...
    public void TaskFighter_Tasks_Tests()
    {
        ...
        fighterTasksContext.AddTask(new TodoTask() { Name = "Test Tasks" });
        fighterTasksContext.AddTask(new TodoTask() { Name = "Test Tasks 2" });
    ...
    public void TaskFighter_Events_Tests()
    {
        ...
        fighterTasksContext.AddEvent(new TodoEvent() { Name = "Test Events" });
        fighterTasksContext.AddEvent(new TodoEvent() { Name = "Test Event 2" });
